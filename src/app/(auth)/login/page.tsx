...
// NOTE: Para que "Continuar con Google" funcione, debe estar habilitado el
// provider Google en el dashboard de Supabase (Auth → Providers → Google)
// y la URL `/api/auth/callback` agregada como redirect URL permitida.
export default function LoginPage() {
  ...
  async function signInWithGoogle() {
    ...
    if (error) {
      ...
      toast.error(mapSupabaseAuthError(error));
    }
  }
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <Button
        ...
        variant="outline"
        size="lg"
        className="press-feedback w-full auth-enter auth-enter-2"
      ...
      <div
        className="relative flex items-center auth-enter auth-enter-3"
        aria-hidden="true"
      >
